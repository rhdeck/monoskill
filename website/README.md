...
3. Use `npx --no-install netlify link --name statechange-monoskill` followed by `npx --no-install netlify deploy --build --prod` only for an explicitly authorized recovery deploy.
