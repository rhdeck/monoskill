...
4. Run the chosen command through the canonical GitHub-backed `npx` invocation in the reference, or an already-installed `monoskill` executable of the same version. Use machine-readable output when available.
