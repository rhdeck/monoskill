...
Target WCAG 2.2 AA. The complete flow must work by keyboard and touch, preserve clear focus and status announcements, maintain contrast, remain useful without animation, and honor `prefers-reduced-motion` without hiding information.
